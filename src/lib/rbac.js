...
export const PERMISSION_GROUPS = [
  {
    ...
    permissions: [
      { key: PERMISSIONS.PAGE_DAILY_SALES, label: 'Daily Sales', detail: 'Main daily sales dashboard' },
      { key: PERMISSIONS.PAGE_CUSTOMER_SERVICE, label: 'Customer & Service', detail: 'Customer type and service revenue reports' },
      { key: PERMISSIONS.PAGE_PAYMENT_CHANNEL, label: 'Payment Channel', detail: 'Cash, bank, and payment channel reports' },
      { key: PERMISSIONS.PAGE_OUTSTANDING_DEBT, label: 'Outstanding Debt', detail: 'Debt balances and unpaid bills' },
      { key: PERMISSIONS.PAGE_AGING_REPORT, label: 'Aging Report', detail: 'Debt aging summary' },
  ...
  },
  {
    ...
    permissions: [
      { key: PERMISSIONS.PAGE_BILLS, label: 'Bills Management page', detail: 'Open the bill records page' },
      { key: PERMISSIONS.PAGE_DEBT, label: 'Debt Management page', detail: 'Open the debt records page' },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: PERMISSIONS.PAGE_SETTINGS, label: 'General Settings page', detail: 'Manage dropdown options used in bill forms' },
    ],
  },
]
